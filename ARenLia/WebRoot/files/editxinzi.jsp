...
<body>
	<s:form name="fom" id="fom" method="post" action="stipendlist_edits">
							...
							<td><table width="95%" border="0" align="center"
									...
									<tr>
										<td height="40" class="font42"><table width="100%"
												...
												<tr bgcolor="#FFFFFF">
													...
													<td ><input name="granttime" value="<s:property value="#stipendQ.xs_granttime"/>"/></td>
												</tr>
												<tr bgcolor="#FFFFFF">
									...
									<TR>
										<TD colspan="2" align="center" height="50px"><input
											...
											onclick=""><a
											href="stipendlist_edits?sid=<s:property value="#stipendQ.xs_id"/>"></a>
