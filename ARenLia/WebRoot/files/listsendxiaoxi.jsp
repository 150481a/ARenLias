...
<body onload="on_load()">
<s:form name="fom" id="fom" method="post" action="Message_send">
        ...
        <tr>
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
               ...
               <td width="49%" align="right">[<s:if test="currPage !=1"><a href="Message_send?currPageStr=1" class="right-font08">首页</a> | <a href="Message_send?currPageStr=<s:property value="currPage-1"/>" class="right-font08">上一页</a></s:if><s:if test="currPage !=totalPage"><a href="Message_send?currPageStr=<s:property value="currPage+1"/>" class="right-font08">下一页</a> | <a href="Message_send?currPageStr=<s:property value="totalPage"/>" class="right-font08">末页</a></s:if>] 转至：</td>
